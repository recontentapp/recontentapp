...
import { DEFAULT_COLORS, getNumber, getRandomColor } from '../utilities'
...
const generateColors = (
  ...
  colors: AvatarProps['colors'] = DEFAULT_COLORS,
) => {
...
export const Sunset: FC<AvatarProps> = props => {
    ...
    >
      ...
      >
        <rect
          width={SIZE}
          height={SIZE}
          rx={props.squared ? undefined : SIZE * 2}
          fill="white"
        />
      </mask>
