...
const routes = {
  ...
  createAnotherWorkspace: {
    url: (params: CreateanotherworkspaceParams) => {
      const path = generatePath('/:workspaceKey/create-another-workspace', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  joinAnotherWorkspace: {
    url: (params: JoinanotherworkspaceParams) => {
      const path = generatePath('/:workspaceKey/join-another-workspace', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  workspaceSettingsBilling: {
    url: (params: WorkspacesettingsbillingParams) => {
      const path = generatePath('/:workspaceKey/settings/billing', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  workspaceSettingsLanguages: {
    url: (params: WorkspacesettingslanguagesParams) => {
      const path = generatePath('/:workspaceKey/settings/languages', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  workspaceSettingsGlossaries: {
    url: (params: WorkspacesettingsglossariesParams) => {
      const path = generatePath('/:workspaceKey/settings/glossaries', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  workspaceSettingsIntegrations: {
    url: (params: WorkspacesettingsintegrationsParams) => {
      const path = generatePath('/:workspaceKey/settings/integrations', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  workspaceSettingsMembers: {
    url: (params: WorkspacesettingsmembersParams) => {
      const path = generatePath('/:workspaceKey/settings/members', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  userSettings: {
    url: (params: UsersettingsParams) => {
      const path = generatePath('/:workspaceKey/settings/user', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  projectPhrases: {
    url: (params: ProjectphrasesParams) => {
      const path = generatePath('/:workspaceKey/projects/:projectId/phrases/:revisionId', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  projectSettings: {
    url: (params: ProjectsettingsParams) => {
      const path = generatePath('/:workspaceKey/projects/:projectId/settings', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  projectImport: {
    url: (params: ProjectimportParams) => {
      const path = generatePath('/:workspaceKey/projects/:projectId/import', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  projectImportFromFile: {
    url: (params: ProjectimportfromfileParams) => {
      const path = generatePath('/:workspaceKey/projects/:projectId/import/from-file', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  projectExport: {
    url: (params: ProjectexportParams) => {
      const path = generatePath('/:workspaceKey/projects/:projectId/export', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  projectDestination: {
    url: (params: ProjectdestinationParams) => {
      const path = generatePath('/:workspaceKey/projects/:projectId/destinations/:destinationId', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  glossary: {
    url: (params: GlossaryParams) => {
      const path = generatePath('/:workspaceKey/glossaries/:glossaryId', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
  ...
  onboardingCreateWorkspace: {
    url: (params: OnboardingcreateworkspaceParams) => {
      const path = generatePath('/onboarding/create-workspace', params.pathParams)
      const queryParams = params.queryParams ? QueryString.stringify(params.queryParams) : undefined
      return queryParams ? `${path}?${queryParams}` : path
    },
