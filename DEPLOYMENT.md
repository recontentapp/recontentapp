...
```sh
# Pull Docker image
docker pull recontentapp/recontentapp-migrate:0.4.1

# Run migrations against database
docker run --env DATABASE_URL="postgres://postgres:postgres@host.docker.internal:6033/recontentapp" recontentapp/recontentapp-migrate:0.4.1
```
...
```sh
# Pull Docker image
docker pull recontentapp/recontentapp:0.4.1

# Run container
docker run -p 127.0.0.1:8080:8080/tcp --env DATABASE_URL="postgres://postgres:postgres@host.docker.internal:6033/recontentapp" recontentapp/recontentapp:0.4.1
```
